...
\begin{align*}
\{\hat{P}_{p'}\hat{P}_{q'}\hat{P}_r^{\dagger}\hat{P}_s\hat{P}_a^{\dagger}\hat{P}_i\hat{P}_p^{\dagger}\hat{P}_q^{\dagger}\}_{fc}&=\wick{\c3 c_{p'-}\c4 c_{p'+}\c5 c_{q'-}\c6 c_{q'+}\c4 c_{r+}^{\dagger}\c3 c_{r-}^{\dagger}\c7 c_{s-}\c8 c_{s+}\c6 c_{a+}^{\dagger}\c5 c_{a-}^{\dagger}\c2 c_{i-}\c1 c_{i+}\c1 c_{p+}^{\dagger}\c2 c_{p-}^{\dagger}\c8 c_{q+}^{\dagger}\c7 c_{q-}^{\dagger}}\\
